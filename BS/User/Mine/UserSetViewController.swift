...
class UserSetViewController: UIViewController {
    ...
    let cellIdentifier = "UserSetTableViewCell"
    var userid = ""
    ...
    func initTableView() {
        ...
        let cellNib = UINib(nibName: "UserSetTableViewCell", bundle: nil)
...
extension UserSetViewController : UITableViewDelegate,UITableViewDataSource {
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        
        let cell = tableView.dequeueReusableCellWithIdentifier(cellIdentifier, forIndexPath: indexPath) as! UserSetTableViewCell
